...
* Use the source of [BusyBox Shell](https://github.com/mirror/busybox/tree/master/shell) for further refernce since it is a smaller implementation with more understandable code. 
...
9. If reveal is passed an invalid flag, print: `reveal: invalid syntax`
10. If `reveal -` is run before any hop has been run since shell start, print: `reveal: no such directory`
