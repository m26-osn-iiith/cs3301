...
### Testing Your Change:
1. Create a user program `user/fcfs_test.c` that forks 3–4 child processes. Have each child print its `pid` multiple times (e.g., in a loop) and then exit.
2. Add `$U/_fcfs_test` to `UPROGS` in `Makefile`.
